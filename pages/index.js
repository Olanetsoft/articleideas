...
export default function Home({ results }) {
  ...
  return (
    <>
      <div className={`flex flex-col items-center m-0 ${styles.body}`}>
        <Head>
      ...
      border border-gray-200 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl"
          ...
          <div
            className="flex flex-col  w-1/2 space-y-2  justify-center  mt-8 sm:space-y-0 sm:flex-row sm:space-x-4 font-Ubuntu sm:flex-row"
            style={{
              display: 'flex',
              flexDirection: 'row',
              flexWrap: 'wrap',
          ...
          >
            <button
              type="button"
              className="btn flex w-fit gap-1 items-center "
            >
              <input
                type="checkbox"
                checked={isSeo}
            ...
            <button type="button" className="btn w-fit flex gap-2 items-center">
              <input
                type="checkbox"
                checked={isCliclbait}
            ...
            <span>
              <button
                type="button"
                className="btn w-fit flex gap-2 items-center"
              >
                <select
                  style={{
                    background: 'inherit',
    ...
    props: {
      results: [
        ...
        },
        {
          id: 6,
          title:
            'Hacktoberfest - Active Open Source Projects Accepting  & Resize Images in the Browser  ',
        },
      ],
    },
  }
